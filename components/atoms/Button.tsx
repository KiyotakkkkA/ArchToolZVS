...
const variantClasses: Record<ButtonVariant, string> = {
  solid:
    "border border-transparent bg-sky-600 text-white shadow-[0_8px_24px_-14px_rgba(30,144,255,0.9)] hover:bg-sky-500 dark:bg-sky-500 dark:hover:bg-sky-400",
  ghost:
    "border border-transparent text-[var(--color-foreground-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-foreground)]",
  outline:
