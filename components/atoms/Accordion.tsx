    ...
    return (
        ...
        >
            <Button
                ...
                className={`h-auto w-full justify-between ${open ? "rounded-b-none" : ""} rounded-t-xl px-3 py-2 text-sm font-medium text-(--color-foreground) hover:translate-y-0 hover:scale-100 ${headerClassName}`}
            >
