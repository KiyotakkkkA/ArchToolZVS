        ...
        <div className="space-y-3 animate-in fade-in slide-in-from-left-1 duration-200">
            <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2 text-sm">
                    <label className="text-(--color-foreground-dim)">
                        Уровень:
                    </label>
                    <Select
                        value={diagramType}
                        onChange={(value) =>
                            onDiagramTypeChange(value as DiagramType)
                        }
            ...
            >
                <InputBig
                    ...
                    spellCheck={false}
                    className="h-105 w-full resize-y rounded-lg border border-(--color-border) bg-(--color-background-elevated) p-3 font-mono text-sm leading-relaxed text-(--color-foreground) outline-none duration-200 focus-visible:ring-2 focus-visible:ring-indigo-500/40"
                />
            </Accordion>
