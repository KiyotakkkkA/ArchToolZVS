...
export function AiEditorView({
    ...
    return (
        <div className="space-y-3 animate-in fade-in slide-in-from-right-1 duration-200">
            ...
            <div className="rounded-lg border border-(--color-border) bg-(--color-background-elevated) p-3">
                <div className="max-h-[56vh] space-y-3 overflow-y-auto pr-1">
                    ...
                    {isLoading ? (
                        <div className="inline-flex max-w-[92%] rounded-lg rounded-tl-md border border-(--color-border) bg-(--color-surface-2) px-3 py-2">
                            <Spinner size="sm" label="Думаю..." />
                        </div>
                    ) : null}

                    {errorText ? (
                        <div className="max-w-[92%] rounded-lg rounded-tl-md border border-rose-500/30 bg-rose-500/10 px-3 py-2 text-sm text-rose-300">
                            {errorText}
                        </div>
                    ) : null}
                </div>
            ...
            <div className="rounded-lg border border-(--color-border) bg-(--color-surface-2) p-2">
